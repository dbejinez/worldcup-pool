        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            @if (session('import_errors'))
                <div class="px-4 py-3 bg-red-100 text-red-800 rounded-md text-sm">
                    <p class="font-semibold mb-1">The file couldn't be imported:</p>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6 space-y-3">
                <h3 class="font-semibold text-gray-800">1. Download the template</h3>
                <p class="text-sm text-gray-600">
                    One file per player. It lists the Round-of-32 matchups and a reference tab with the exact team names.
                </p>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6 space-y-3">
                <h3 class="font-semibold text-gray-800">2. Upload a completed file</h3>
                <p class="text-sm text-gray-600">
                    Fill in the player's email, a winner for every match, and the Final score (Champion &gt; Runner-up).
                    Accepts <strong>.xlsx</strong> or <strong>.csv</strong>. The pool must be open for picks.
                </p>
